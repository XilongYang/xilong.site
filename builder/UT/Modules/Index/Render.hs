...
testGenIndexHtmlGroupsAndSortsByDate =
  mkTestCase "renderIndex groups items by year and orders dates descending in a year" $ do
    let items =
    ...
    let rendered = renderIndex items "<main>$posts$</main>"
